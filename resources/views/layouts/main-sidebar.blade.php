...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">Arqco</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/atdashboard') }}"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page = 'services') }}">قائمة الخدمات</a></li>                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page = 'our-work') }}">معرض الاعمال</a></li>
                </ul>
            </li>
            <li class="side-item side-item-category">من نحن</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
