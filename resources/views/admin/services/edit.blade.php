                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="features_ar" name="features_ar" rows="3" required>{{ old('features_ar', is_array($service->features_ar) ? implode(', ', $service->features_ar) : (is_string($service->features_ar) ? implode(', ', json_decode($service->features_ar, true) ?: []) : $service->features_ar)) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="features_en" name="features_en" rows="3" required>{{ old('features_en', is_array($service->features_en) ? implode(', ', $service->features_en) : (is_string($service->features_en) ? implode(', ', json_decode($service->features_en, true) ?: []) : $service->features_en)) }}</textarea>
                                    <small class="form-text text-muted">افصل بين كل مميزة بفاصلة</small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted" id="statusText">
                                        {{ old('status', $service->status) ? 'نشط' : 'غير نشط' }}
                                    </small>
                                </div>
                            </div>
                        </div>
