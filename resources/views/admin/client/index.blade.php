                                        ...
                                        <div class="col-md-3 col-sm-6 mb-4">
                                            <div class="card client-card">
                                                <div class="card-body text-center">
                                                    ...
                                                    @if($client->link)
                                                        <a href="{{ $client->link }}" target="_blank" class="btn btn-sm btn-outline-primary mt-2">
                                                            <i class="fas fa-external-link-alt"></i> الموقع
                                                        </a>
                                                    @endif
                                                    
                                                    <div class="client-actions mt-2">
                                                        <span class="badge {{ $client->status ? 'badge-success' : 'badge-secondary' }}">
                                                            {{ $client->status ? 'نشط' : 'غير نشط' }}
                                                        </span>
