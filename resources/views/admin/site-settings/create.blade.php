    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">إضافة إعدادات الموقع</h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="site_name_ar" name="site_name_ar" 
                                       value="{{ old('site_name_ar') }}" placeholder="اسم موقعك بالعربية">
                                @error('site_name_ar')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="site_name_en" name="site_name_en" 
                                       value="{{ old('site_name_en') }}" placeholder="Your site name in English">
                                @error('site_name_en')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" 
                                       value="{{ old('phone') }}" placeholder="+966 50 123 4567">
                                @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description_ar" name="description_ar" rows="4" 
                                          placeholder="وصف قصير عن موقعك وخدماتك بالعربية">{{ old('description_ar') }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description_en" name="description_en" rows="4" 
                                          placeholder="Brief description about your site and services in English">{{ old('description_en') }}</textarea>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="address_ar" name="address_ar" rows="4" 
                                          placeholder="وصف قصير عن موقعك وخدماتك بالعربية">{{ old('address_ar') }}</textarea>
                                @error('address_ar')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="clients_count" name="clients_count" min="0">
                                @error('clients_count')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="satisfaction_rate" name="satisfaction_rate" min="0" max="100">
