<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/images/arqco-logo.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/images/arqco-logo.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/images/arqco-logo.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/arqco-logo.png') }}">
    ...
    <meta property="og:image" content="@yield('og-image', asset('assets/images/arqco-og-image.jpg'))">
    ...
    <meta name="twitter:image" content="@yield('twitter-image', asset('assets/images/arqco-twitter-image.jpg'))">
    ...
    <script type="application/ld+json">
    {
        ...
        "logo": "https://arqco-events.com/assets/images/arqco-logo.png",
        "contactPoint": {
            "@type": "ContactPoint",
        ...
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "شارع الياسمين - القادسية",
        ...
        "description": "Arqco Events - الشركة الرائدة في تنظيم وتجهيز المؤتمرات والمعارض والفعاليات والخيام الأوروبية في المملكة العربية السعودية",
        "keywords": "تجهيز مؤتمرات, تنظيم معارض, خيام أوروبية, فعاليات, حفلات, event management, conference organization, exhibition setup, wedding planning, corporate events, Saudi Arabia, Riyadh, Jeddah, Dammam",
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "LocalBusiness",
        "name": "Arqco Events",
        "image": "https://arqco-events.com/assets/images/arqco-logo.png",
        "telephone": "+966-50-000-0000",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "شارع الياسمين - القادسية",
