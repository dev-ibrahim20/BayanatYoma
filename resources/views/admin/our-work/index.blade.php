            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('our-work.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-preview-container">
                                                <img src="{{ asset('Arqco/public/' . $work->image) }}" 
                                                        alt="{{ $work->title }}" 
                                                        ...
                                                        onclick="openPortfolioModal('{{ $work->id }}', 0)"
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item" href="{{ route('our-work.edit', $work->id) }}">
                                                        <i class="fas fa-edit text-primary"></i> تعديل
                                                    </a>
                                                    <a class="dropdown-item" href="#" onclick="deletePortfolio({{ $work->id }}); return false;" data-portfolio_id="{{ $work->id }}">
